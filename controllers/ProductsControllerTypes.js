...
exports.findAll = (req, res) => {
    ...
    ProductType.find(filterBy, { _id: 0 }, { sort: { [sortBy]: orderBy }, collation: { locale: 'en' }, populate: [{path: 'subcategory', model: "productsSubCategories", select: 'name -_id'}] }, (err, result) => {
...
exports.findOne = (req, res) => {
    ...
    ProductType.findById(req.params.id, { _id: 0 }, { populate: [{path: 'subcategory', model: "productsSubCategories", select: 'name id -_id'}] }, (err, result) => {
...
exports.addOne = (req, res) => {
    ...
    ProductType.create(type, (err, result) => {
        ...
        if (err) {
            ...
            ProductType.findByIdAndUpdate(result._id, result, (err, result) => {
...
exports.updateOne = (req, res) => {
    ...
    ProductType.findByIdAndUpdate(req.params.id, type, { runValidators: true }, (err, result) => {
...
//     ProductType.findByIdAndDelete(req.params.id, (err, result) => {
