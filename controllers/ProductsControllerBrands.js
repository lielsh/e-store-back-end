...
exports.findAll = (req, res) => {
    ...
    ProductBrand.find(filterBy, { _id: 0 }, { sort: { [sortBy]: orderBy }, collation: { locale: 'en' } }, (err, result) => {
...
exports.findOne = (req, res) => {
    ...
    ProductBrand.findById(req.params.id, { _id: 0 }, (err, result) => {
...
exports.addOne = (req, res) => {
    ...
    ProductBrand.create(brand, (err, result) => {
        ...
        if (err) {
            ...
            ProductBrand.findByIdAndUpdate(result._id, result, (err, result) => {
...
exports.updateOne = (req, res) => {
    ...
    ProductBrand.findByIdAndUpdate(req.params.id, brand, { runValidators: true }, (err, result) => {
...
//     ProductBrand.findByIdAndDelete(req.params.id, (err, result) => {
