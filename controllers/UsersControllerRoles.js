...
exports.findAll = (req, res) => {
    ...
    UserRole.find(filterBy, { _id: 0 }, { sort: { [sortBy]: orderBy }, collation: { locale: 'en' } }, (err, result) => {
...
exports.findOne = (req, res) => {
    ...
    UserRole.findById(req.params.id, { _id: 0 }, (err, result) => {
...
exports.addOne = (req, res) => {
    ...
    UserRole.create(role, (err, result) => {
        ...
        if (err) {
            ...
            UserRole.findByIdAndUpdate(result._id, result, (err, result) => {
...
exports.updateOne = (req, res) => {
    ...
    UserRole.findByIdAndUpdate(req.params.id, role, { runValidators: true }, (err, result) => {
...
//     UserRole.findByIdAndDelete(req.params.id, (err, result) => {
