...
exports.findAll = (req, res) => {
    ...
    TicketStatus.find(filterBy, { _id: 0 }, { sort: { [sortBy]: orderBy }, collation: { locale: 'en' } }, (err, result) => {
...
exports.findOne = (req, res) => {
    ...
    TicketStatus.findById(req.params.id, { _id: 0 }, (err, result) => {
...
exports.addOne = (req, res) => {
    ...
    TicketStatus.create(status, (err, result) => {
        ...
        if (err) {
            ...
            TicketStatus.findByIdAndUpdate(result._id, result, (err, result) => {
...
exports.updateOne = (req, res) => {
    ...
    TicketStatus.findByIdAndUpdate(req.params.id, status, { runValidators: true }, (err, result) => {
